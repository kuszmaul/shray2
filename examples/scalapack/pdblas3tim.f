! TODO delete everything not pertaining to PDGEMM, generate the input
! matrices automatically instead of reading in via files, output
! Gflops/s instead of time, take size and number of processors as
! argument.
