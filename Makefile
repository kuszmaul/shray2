...
FLAGS = -O3 -march=native -mtune=native -Wall -ffast-math -Wextra -pedantic -fno-math-errno -I/home/thomas/work/dsm/shray2.0/include/shray2/
...
FORTRANAPPS = $(wildcard examples/*.f90)
